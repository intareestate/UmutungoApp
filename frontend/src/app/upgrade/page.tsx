...
export default function UpgradePage() {
  ...
  return <main className="upgrade-page">
    <header className="upgrade-header"><Link href="/" aria-label="Return to Umutungo home"><Logo /></Link><div><span>Tenant account</span><Link href="/">Back to marketplace <Icon name="arrow" size={14} /></Link></div></header>
